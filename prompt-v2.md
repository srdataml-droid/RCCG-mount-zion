...
## 1. Optional cosmetic rename
**Status:** ⬜ Pending — doing this first, per instruction
...
everything already works correctly either way.
```

## 2. Admin page
**Status:** ⬜ Pending — doing this next, per instruction
...
## 3. Give page — real bank transfer details
**Status:** ⬜ Pending
...
## 4. Full production-readiness pass
